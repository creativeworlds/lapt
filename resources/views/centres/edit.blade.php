<x-layout title="Edit Centre">
    <main class="centres-edit-blade main-content-div">
        <x-centre-tab />
                        ...
                        <form action="{{ route('centres.update', $centre) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control form-select" name="centre_category_id" id="centreCategoryId">
                                        @foreach ($centreCategories as $centreCategory)
                                            <option value="{{ $centreCategory->id }}" @selected($centre->centre_category_id == $centreCategory->id)>{{ $centreCategory->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-6 mt-3 mt-lg-0">
                                    ...
                                    <select class="form-control form-select" name="type" id="type">
                                        @foreach ($centreTypes as $centreType)
                                            <option value="{{ $loop->iteration }}" @selected($centre->type == $loop->iteration)>{{ $centreType }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-6 mt-3">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" value="{{ $centre->name }}" />
                                    @error('name') <p class="text-danger mt-1">{{ $message }}</p> @enderror
                                </div>

                                <div class="form-group col-md-6 mt-3">
                                    <label class="form-label">Enter Centre Code</label>
                                    <input type="text" class="form-control" name="code" id="code" value="{{ $centre->code }}" />
                                    @error('code') <p class="text-danger mt-1">{{ $message }}</p> @enderror
                                </div>

                                <div class="form-group col-md-12 mt-3">
                                    <label class="form-label">Address</label>
                                    <textarea cols="45" rows="5" class="ckeditor" name="address" id="address">{{ $centre->address }}</textarea>
                                ...
                                <div class="form-group col-md-6 mt-3">
                                    ...
                                    <select name="country_id" class="form-control country form-select" id="countryId" onchange="getStates(this.value)">
                                        ...
                                        @foreach ($countries as $country)
                                            <option value="{{ $country->id }}" @selected($centre->country_id == $country->id)>{{ $country->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-md-6 mt-3">
                                    ...
                                    <select class="form-control form-select state" name="state_id" id="stateId">
                                        ...
                                        @if($centre->country_id)
                                            @foreach ($countries->find($centre->country_id)->states as $state)
                                                <option value="{{ $state->id }}" @selected($centre->state_id == $state->id)>{{ $state->name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                ...
                                <div class="form-group col-md-6 mt-3">
                                    ...
                                    <select name="currency" id="currency" class="form-control form-select currency">
                                        @foreach ($currencies as $currency)
                                            <option value="{{ $currency }}" @selected($centre->currency == $currency)>{{ $currency }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-6 mt-3">
                                    ...
                                    <select name="tax_type" id="taxType" class="form-control form-select tax-type">
                                        @foreach ($taxTypes as $taxType)
                                            <option value="{{ $taxType }}" @selected($centre->tax_type == $taxType)>{{ $taxType }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-6 mt-3">
                                    ...
                                    <input type="text" name="gst_number" id="gstNumber" class="form-control" value="{{ $centre->gst_number }}" />
                                </div>
                                ...
                                <div class="form-group col-md-6 mt-3">
                                    ...
                                    <select name="preferred_seller" id="preferredSeller" class="form-control form-select">
                                        @foreach ($preferredSellers as $preferredSeller)
                                            <option value="{{ $preferredSeller }}" @selected($centre->preferred_seller == $preferredSeller)>{{ $preferredSeller }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-6 mt-3">
                                    ...
                                    <input type="hidden" name="gst_mode" id="gstMode" value="{{ $centre->gst_mode }}" />
                                ...
                                <div class="form-group col-md-6 mt-3">
                                    ...
                                    <input type="text" class="form-control" name="city" id="city" size="30" value="{{ $centre->city }}" />
                                    @error('city') <p class="text-danger mt-1">{{ $message }}</p> @enderror
                                </div>

                                <div class="form-group col-md-6 mt-3">
                                    <label class="form-label">Contact Person</label>
                                    <input type="text" class="form-control" name="contact_person" id="contactPerson" value="{{ $centre->contact_person }}" />
                                    @error('contact_person') <p class="text-danger mt-1">{{ $message }}</p> @enderror
                                </div>

                                <div class="form-group col-md-6 mt-3">
                                    <label class="form-label">Mobile Number</label>
                                    <input type="text" class="form-control" name="mobile" id="mobile" value="{{ $centre->mobile }}" />
                                    @error('mobile') <p class="text-danger mt-1">{{ $message }}</p> @enderror
                                </div>

                                <div class="form-group col-md-6 mt-3">
                                    <label class="form-label">Phone Number</label>
                                    <input type="text" class="form-control" name="phone" id="phone" value="{{ $centre->phone }}" />
                                </div>

                                <div class="form-group col-md-6 mt-3">
                                    <label class="form-label">Fax</label>
                                    <input type="text" class="form-control" name="fax" id="fax" value="{{ $centre->fax }}" />
                                </div>

                                <div class="form-group col-md-6 mt-3">
                                    <label class="form-label">Email</label>
                                    <input type="text" class="form-control" name="email" id="email" value="{{ $centre->email }}" />
                                ...
                                <div class="form-group col-md-6 mt-3">
                                    ...
                                    <input type="text" name="website" class="form-control" id="website" value="{{ $centre->website }}" />
                                </div>

                                <div class="form-group col-md-6 mt-3">
                                    <label class="form-label">Facebook</label>
                                    <input type="text" name="facebook" class="form-control" id="facebook" value="{{ $centre->facebook }}" />
                                </div>

                                <div class="form-group col-md-6 mt-3">
                                    <label class="form-label">Twitter</label>
                                    <input type="text" name="twitter" class="form-control" id="twitter" value="{{ $centre->twitter }}" />
                                </div>

                                <div class="form-group col-md-6 mt-3">
                                    <label class="form-label">Instagram</label>
                                    <input type="text" name="instagram" class="form-control" id="instagram" value="{{ $centre->instagram }}" />
                                </div>

                                <div class="form-group col-md-6 mt-3">
                                    <label class="form-label">LinkedIn</label>
                                    <input type="text" name="linkedin" class="form-control" id="linkedin" value="{{ $centre->linkedin }}" />
                                </div>

                                <div class="form-group col-md-6 mt-3">
                                    <label class="form-label">Password</label>
                                    <input type="text" name="password" class="form-control" id="password" value="{{ $centre->password }}" />
                                    @error('password') <p class="text-danger mt-1">{{ $message }}</p> @enderror
                                </div>

                                <div class="form-group col-md-4 mt-4 d-flex flex-column align-items-center py-3">
                                    <label class="form-label">Chairman Sign Preview</label>
                                    <img style="width: 100px;" src="{{ asset("/storage/{$centre->chairman_sign}") }}" alt="img missing">
                                </div>

                                <div class="form-group col-md-4 mt-4 d-flex flex-column align-items-center py-3">
                                    <label class="form-label">Examiner Sign Preview</label>
                                    <img style="width: 100px;" src="{{ asset("/storage/{$centre->examiner_sign}") }}" alt="img missing">
                                </div>

                                <div class="form-group col-md-4 mt-4 d-flex flex-column align-items-center py-3">
                                    <label class="form-label">Center Logo Preview</label>
                                    <img style="width: 100px;" src="{{ asset("/storage/{$centre->logo}") }}" alt="img missing">
                                </div>
                                ...
                                <div class="form-group col-md-6 mt-3">
                                    <label class="form-label">Upload centre Logo</label>
